...
imgs = ['transA.jpg', 'transB.jpg', 'uttower_left.jpg', 'uttower_right.jpg']
#imgs = ['left-2.jpg', 'right-2.jpg', 'left-1.jpg', 'right-1.jpg']
...
def ps4_3_b():
    simA = cv2.imread('input/uttower_left.jpg', cv2.IMREAD_COLOR)
    simB = cv2.imread('input/uttower_right.jpg', cv2.IMREAD_COLOR)
